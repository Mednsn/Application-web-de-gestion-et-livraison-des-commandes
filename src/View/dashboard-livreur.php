...
$cmndRepo = new CommandeRepository($pdo);

$cmnd = $cmndRepo->selectAll();
// var_dump($cmnd['date']);exit;
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="flex items-center space-x-3 pl-6 border-l-2 border-gray-500">
                    <div class="text-right hidden sm:block">
                        <p id="user-name" class="text-sm font-semibold text-gray-900 leading-tight"><?php echo $user->getName(); ?></p>
        ...
        <main class="flex-1 overflow-y-auto bg-gray-100 p-4 sm:p-8">
            ...
            <div id="view-market" class="fade-in max-w-6xl mx-auto">
                ...
                <div id="marketContainer" class="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <!-- Orders Injected Logic -->
                    <?php if($cmnd): ?>
                     <?php foreach($cmnd as $comnd): ?>
                        <div class="p-6 flex flex-col flex-1 bg-gray-200  border-2 rounded hover:shadow-xl">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <span class="text-xs text-gray-400 font-medium"><i class="far fa-clock mr-1"></i> <?php echo $comnd['date_creation']; ?></span>
                            </div>
                            ...
                            <div class="space-y-4 mb-4 flex-grow relative pl-4 border-l-2 border-gray-100 ml-1">
                                <div class="relative">
                                    ...
                                    <p class="text-sm font-semibold text-gray-800 leading-tight"><?php echo $comnd['adress_depart']; ?></p>
                                </div>
                                <div class="relative">
                                    ...
                                    <p class="text-sm font-semibold text-gray-800 leading-tight"><?php echo $comnd['adress_livraison']; ?></p>
                                </div>
                            </div>
                            
                            <div class="bg-gray-50 rounded-lg p-3 text-xs text-gray-600 mb-4 line-clamp-2">
                                <?php echo $comnd['description'] ?>
                            </div>
                            
                            <div class="flex items-center justify-between text-xs text-gray-500 mt-auto pt-4 border-t border-gray-50">
                                <div class="flex items-center">
                                    <i class="fas fa-users text-gray-400 mr-2"></i><?php echo $user->getId(); ?> number offrs concurrents
                                </div>
                                <div class="font-bold text-gray-900">Offre max: 5</div>
                            </div>
                            
                            <button onclick="openOfferModal('${order.id}')" class="w-full rounded bg-gray-50 hover:bg-indigo-600 hover:text-white text-indigo-600 font-bold py-3 text-sm transition-colors border-t border-gray-100">
                                Faire une offre
                            </button>
                        </div>
            ...
            <div id="view-active" class="hidden fade-in max-w-4xl mx-auto">
                ...
                <div id="active-container" class="space-y-4">
                    <!-- Active Deliveries -->
                    <div class="p-8 text-center text-gray-500 bg-white rounded-xl shadow-sm">Vous n'avez aucune livraison active. Allez au marché pour en trouver !</div>
                </div>
            </div>
                        ...
                        <form onsubmit="handleUpdateProfile(event)" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="nom" id="profile-nom" 
                                ...
                                <div>
                                    ...
                                    <input type="text" name="prenom" id="profile-prenom" 
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <form action="../Controler/OfferControler.php" method="POST" class="space-y-4">
