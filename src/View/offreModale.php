...
require_once __DIR__ . '/../Modale/Entity/StatutCommande.php';
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="flex items-center space-x-3 pl-6 border-l-2 border-gray-500">
                    <div class="text-right hidden sm:block">
                        <p id="user-name" class="text-sm font-semibold text-gray-900 leading-tight"><?php echo $user->name; ?></p>
                    ...
                    <?php if($cmnd): ?>
                     <?php foreach($cmnd as $comnd): ?>
                        <div class="p-6 flex flex-col flex-1 bg-gray-200  border-2 rounded hover:shadow-xl">
                            ...
                            <button type="submit"  class="w-full rounded bg-gray-50 hover:bg-indigo-600 hover:text-white text-indigo-600 font-bold py-3 text-sm transition-colors border-t border-gray-100">
                                Faire une offre
                            </button>
                            </form>
                        </div>
                    ...
                    <div class="p-8">
                        <form onsubmit="handleUpdateProfile(event)" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="profile-email" value="<?php echo $user->email ?>"
                                    class="bg-black/5 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none">
                            </div>
