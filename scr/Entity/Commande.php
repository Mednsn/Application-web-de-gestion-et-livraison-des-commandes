...
public function __construct(string $description ,string  $adress_depart ,string $adress_livraison,DATETIME $date_creation,DATETIME $date_modification ,User $client, StatutCommande $status,bool $is_deleted,?int $id=NULL)
{
