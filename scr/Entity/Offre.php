...
class Notification {
    ...
    public function __construct(float $prix, string $duree_estimee, string $option, bool $is_accept, DATETIME $date_creation, Vehicule $vehicule, User $livreur, Commande $commande,  ?int $id=NULL)
    {
        $this->prix = $prix;
